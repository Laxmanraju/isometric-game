...
-(void)animateCharacter
{
    ...
    [walkFrame release];
    //  [walkFrameCache release]; //////to be released at the end of walk cycle
...
-(void) characterControl
{
    for (int i=0; i< [allCharacters count]; i++) {
        ...
        [tCharacter updateAvatarPosition];
    }
}
...
{   
    ...
    aCharacter.characterTypeName = [self getCustomerType:charName];
    [levelCharacters removeObject:charName];
