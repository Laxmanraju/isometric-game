...
//#import "PTGameEngineController.h"
...
//	if (![[PTGameEngineController sharedInstance] checkForGestureDisablewithPoint:[touch locationInView:[[CCDirector sharedDirector] openGLView]]])
//	{
//		return NO;
//	}
...
{
	return [NSString stringWithFormat:@"<%@ = %8@ | %@ | Node = %@ >", [self class], self, [gestureRecognizer_ class], node_];
}
